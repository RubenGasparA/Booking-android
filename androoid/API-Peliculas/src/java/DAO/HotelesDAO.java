 ...
 * @author S1-PC52
 */
public class HotelesDAO implements DAO<Hoteles, Integer> {
    ...
    @Override
    public void visualizar(Hoteles bean) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public ArrayList<Hoteles> findAll(Hoteles bean) {
         String sql_filtro = "";
        String sql_final = "";
        ArrayList<Hoteles> lstPeliculas = null;
          try {
            this.motor.connect();
    ...
    public ArrayList<Hoteles> getFichaTecnica(Hoteles bean){
      String sql_filtro = "";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroDrama(Hoteles bean){
      String sql_filtro = "1";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroDeporte(Hoteles bean){
      String sql_filtro = "2";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroBiografica(Hoteles bean){
      String sql_filtro = "3";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroEpica(Hoteles bean){
      String sql_filtro = "4";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroBelica(Hoteles bean){
      String sql_filtro = "5";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroComedia(Hoteles bean){
      String sql_filtro = "6";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> getGeneroAccion(Hoteles bean){
      String sql_filtro = "7";
        String sql_final = "";
         ArrayList<Hoteles> lstPeliculas = null;
          try {
    ...
    public ArrayList<Hoteles> pelisMasvotadas(Hoteles bean) {
         String sql_filtro = "";
        String sql_final = "";
        ArrayList<Hoteles> lstPeliculas = null;
          try {
