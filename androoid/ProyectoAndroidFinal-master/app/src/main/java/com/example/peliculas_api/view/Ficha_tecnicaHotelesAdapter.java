...
public class Ficha_tecnicaHotelesAdapter extends RecyclerView.Adapter<Ficha_tecnicaHotelesAdapter.ViewHolder>{

    private ArrayList<Hoteles> datospeliculas;
    private Context context;

    public Ficha_tecnicaHotelesAdapter(Context context){
